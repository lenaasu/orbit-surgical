...
class BCPolicy(nn.Module):
    def __init__(self, obs_dim=34, act_dim=8):
        super().__init__()
...
save_path = IL_DIR / "policies" / "bc_actor_rsl.pt"

def train():
    parser = argparse.ArgumentParser(description="Train BC policy using imitation for Isaac Lab environments.")
    # parser.add_argument("--num_envs", type=int, default=1, help="Number of environments to simulate.")
    # parser.add_argument("--task", type=str, default="Isaac-Lift-Needle-PSM-IK-Abs-Play-v0", help="Name of the task.")
    ...
    torch.save({"model_state_dict": policy.net.state_dict(),
                "obs_dim": 34,
                "act_dim": 8,
                }, 
                save_path,
